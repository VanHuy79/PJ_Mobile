            ...
            <ScrollView > 
                <SafeAreaView style ={{backgroundColor: '#dfe6e9'}}>
                    <View style ={style.header}>
                        <TouchableOpacity>
                            <Image source={require("../assets/icon/user2.png")}
                                style ={{width:80,height:80, marginTop:20,}}/>
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <Text style ={{fontSize:20, fontWeight:"bold", color:'white', marginTop:20, marginBottom:15}}>Thay đổi ảnh đại diện</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style ={style.detail}>
                        ...
                        <View style ={style.kc}>
                            <TouchableOpacity style ={style.detaiIcon}>
                                <Image source ={require("../assets/icon/friendship.png")}
                                    style ={style.img}/>
                        ...
                        <View style ={style.kc}>
                            <TouchableOpacity style ={style.detaiIcon}>
                                <Image source ={require("../assets/icon/telephone.png")}
                                    style ={style.img}/>
                        ...
                        <View style ={style.kc}>
                            <TouchableOpacity style ={style.detaiIcon}>
                                <Image source ={require("../assets/icon/home2.png")}
                                    style ={style.img}/>
