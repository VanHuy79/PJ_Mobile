        ...
        return(
            ...
            <ScrollView >
                ...
                <View style= {STYLES.inputContainer}>
                    ...
                    />
                    <TextInput placeholder = "Account" style={STYLES.input} value={this.state.User}
                ...
                <View style={{ justifyContent :'space-between',}}>
                    <TouchableOpacity style = {{alignItems:'center'}}>
                        <View style={STYLES.btnSeondary}>
                            <Text style={{fontWeight:'bold',fontSize:15}}>Đăng nhập với</Text>
                    ...
                    <TouchableOpacity onPress ={()=>this.navigation.navigate('Home')} 
                        ...
                        <View style={STYLES.btnSeondary}>
                            <Text style={{fontWeight:'bold',fontSize:15}}>Khách</Text>
                ...
                <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',marginTop:30,marginBottom:20,}}>
                    <Text style={{color:'#a5a5a5', fontWeight:'bold', fontSize: 20,}}>Chưa có tài khoản ?</Text>
                    <TouchableOpacity onPress ={()=> this.navigation.navigate('Signup')} >
                        <Text style={{color:"#ff2d5f", fontWeight:'bold', marginLeft:5, fontSize: 20,}}>Đăng ký</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
            </SafeAreaView>
