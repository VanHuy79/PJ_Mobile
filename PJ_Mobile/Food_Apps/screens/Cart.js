            ...
            return (
              <View style={style.cart}>
                <View style={style.img}>
                  <Image
                    style={{width: 120, height: 120, borderRadius:20, marginTop: 3, marginLeft: 5}}
                    source={{uri: cart.img}}
                  />
                </View>
                ...
                <View style={style.title}>
                  ...
                  <Text style={{marginLeft:10, fontSize:18}}>{cart.tongdon.toFixed()} đ</Text>
                ...
                <SafeAreaView style ={{backgroundColor:"white"}}>
                    <View style={style.header}>
                        <View style ={style.back}>
                          ...
                          <Text style ={{fontSize:21, fontWeight:'bold', marginTop:10 }}> Giỏ hàng</Text>
                        </View>
                        
                        <TouchableOpacity onPress = {()=> this.navigation.navigate("Address")}>
                          <View style={{width:130, height:40, backgroundColor:"#e51f28", justifyContent:"center", borderRadius:10,marginRight:15, marginTop: 10}}>
                            <Text style ={{color:"white", fontWeight:"bold", fontSize:21, textAlign:"center"}}>Thanh toán</Text>
                          </View>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style ={{flexDirection:'row'}}>
                        ...
                        />
                        <Text style ={{fontSize:17, marginLeft:5,color:"grey", fontWeight:'bold'}}>
                            Địa chỉ nhận hàng:
                        </Text>
                    </View>
                    <TouchableOpacity>
                        <View style ={{paddingVertical:10}}>
                            <Text style ={{fontSize:17,  marginLeft:5, fontWeight:'bold'}}>Ngô Văn Huy - 123456789</Text>
                            <Text style ={{fontSize:17,  marginLeft:5, fontWeight:'bold'}}>235 Hoàng Quốc Việt</Text>
                        </View>
                    </TouchableOpacity>
                </View>
